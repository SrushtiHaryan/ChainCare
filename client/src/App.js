...
import PurchasePatient from "./pages/Patient/PurchasePatient";
...
import ReceivePatient from "./pages/Patient/ReceivePatient";
import ReceivedByPatient from "./pages/Patient/ReceivedByPatient";
      ...
      <div className="App">
        ...
        <Router history={createBrowserHistory()}>
          <Switch>
            ...
            <Route exact path="/Patient/buy">
            {this.state.cRole !== "" ?
              <PurchasePatient accounts={this.state.accounts} supplyChainContract={this.state.contract} />
              : <h1>Assign Patient Role at /RoleAdmin</h1> }
            </Route>
            ...
            <Route exact path="/Patient/receive">
            {this.state.cRole !== "" ?
              <ReceivePatient accounts={this.state.accounts} supplyChainContract={this.state.contract} />
              : <h1>Assign Patient Role at /RoleAdmin</h1> }
            </Route>
            <Route exact path="/Patient/allReceived">
            {this.state.cRole !== "" ?
              <ReceivedByPatient accounts={this.state.accounts} supplyChainContract={this.state.contract} />
              : <h1>Assign Patient Role at /RoleAdmin</h1> }
            </Route>
